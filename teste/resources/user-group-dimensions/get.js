...
try {
	...
	if (!internal) {
		userGroupDimensionsBusiness.canGet(ctx, dpd, me, _userGroupDimension, function (canGet) {
	...
	if (typeof query.include !== 'undefined' && query.include.indexOf('dimension') > -1) {
		dpd.dimensions.get(_userGroupDimension.dimensionId, function (dimension, error) {
			if (error) {
