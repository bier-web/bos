...
try {
    ...
    if (!internal) {
        userGroupPermissionsBusiness.canGet(ctx, bbc, me, _userGroupPermission, function (canGet) {
    ...
    if (typeof query.include !== "undefined" && query.include.indexOf("permission") > -1) {
        bbc.permissions.get(_userGroupPermission.permissionId, function (permission, error) {
            if (error) {
