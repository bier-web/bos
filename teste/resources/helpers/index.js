...
var prepareTemplateToSendEmail = function (bbc, templateId, templateProps, callback) {
    bbc.htmltemplates.get(templateId, function (htmlTemplate, error) {
        if (error) {
...
var sendEmail = function (bbc, emailTo, emailSubject, emailContentText, emailContentHtml, callback) {
