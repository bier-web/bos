try {
    ...
    if (!internal) {
        ...
        systemSettingsBusiness.canPost(ctx, bbc, me, _systemSetting, function (canPut) {
            if (canPut) {
                systemSettingsBusiness.onPut(ctx, bbc, me, _systemSetting, function (systemSettingToPut) {
