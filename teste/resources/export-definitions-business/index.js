...
var exportDefinitionsBusiness = {
    canGet: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            securityBusiness.hasPermissionToAction(ctx, bbc, loggedUser, exportDefinition, "exportdefinitions", helpers.helperServer.both.actions.read, function (canRead) {
    ...
    */
    canPost: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            securityBusiness.hasPermissionToAction(ctx, bbc, loggedUser, exportDefinition, "exportdefinitions", helpers.helperServer.both.actions.add, function (canAdd) {
                if (canAdd) {
                    callback(true);
                } else {
    ...
    */
    onPost: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            auditBusiness.logAction(
                ...
                loggedUser,
                "exportdefinitions",
                "(" + exportDefinition.id + ") - " + exportDefinition.name,
    ...
    */
    canPut: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            securityBusiness.hasPermissionToAction(ctx, bbc, loggedUser, exportDefinition, "exportdefinitions", helpers.helperServer.both.actions.edit, function (canEdit) {
                if (canEdit) {
                    /*
                    Abaixo, o padrão que deve ser mantido para validações. Atentar-se para o conceito da validação!
                    Experimente ref-bbc-canput-validation
                */
                    callback(true);
                } else {
                    callback(false, "Usuário não tem permissão");
    ...
    */
    onPut: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
    ...
    */
    canDelete: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            securityBusiness.hasPermissionToAction(ctx, bbc, loggedUser, exportDefinition, "exportdefinitions", helpers.helperServer.both.actions.remove, function (canRemove) {
                /*
                    Abaixo, o padrão que deve ser mantido para validações. Atentar-se para o conceito da validação!
                */
                ...
                if (canRemove) {
                    ...
                    // Experimente ref-bbc-candelete-validation
                } else {
                    callback(false, "Usuário não tem permissão");
                }
            });
    ...
    */
    onDelete: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            helpers.log("exportDefinitionsBusiness -> onDelete -> begin");
            // helpers.log('exportDefinitionsBusiness -> canPut -> Registrando log de auditoria');
            // auditBusiness.logAction(bbc, helpers.helperServer.both.actions.edit, loggedUser, 'exportdefinitions', '(' + exportDefinition.id + ') - ' + exportDefinition.name, ctx.req.headers['x-real-ip']);
    ...
    */
    prepareObjectToPost: function (ctx, bbc, loggedUser, exportDefinition, callback) {
        try {
            ...
            securityBusiness.prepareObjectToPost(ctx, bbc, loggedUser, exportDefinition, "exportdefinitions", function (objectToPost) {
                /*
