...
var exportReportsBusiness = {
    canGet: function (ctx, bbc, loggedUser, exportReport, query, callback) {
        try {
            securityBusiness.hasPermissionToAction(ctx, bbc, loggedUser, exportReport, "exportreports", helpers.helperServer.both.actions.read, function (canRead) {
                if (canRead) {
                    callback(true);
                } else {
