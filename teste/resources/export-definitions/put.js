try {
    ...
    exportDefinitionsBusiness.canPut(ctx, bbc, me, exportDefinition, function (canPut, message) {
        if (canPut) {
            helpers.log("exportdefinitions -> onPut -> Chamando exportDefinitionsBusiness -> canPut ok, chamando onPut");
            exportDefinitionsBusiness.onPut(ctx, bbc, me, exportDefinition, function (objectoToPost) {
