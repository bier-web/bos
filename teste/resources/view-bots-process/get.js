...
if (!internal) {
	auditBusiness.logAction(dpd, helpers.helperServer.both.actions.tryGet, ctx.body, 'ViewBotsProcess', ' *** Agent: ' + ctx.req.headers['user-agent'], ctx.req.headers['x-real-ip']);
