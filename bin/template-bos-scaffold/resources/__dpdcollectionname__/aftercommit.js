...
try {
	...
	dpd.__collection__.get({ id: __objectItem__.id, paginationSettings: { skip: 0, limit: 1 } }, function (__collection__) {
	...
	helpers.helperServer.showException(helpers.helperServer.both.formatString('BierOnStack: Recurso __dpdcollectionname__ :: Evento :: AfterCommit :: Exceção :: {0}', error.message));
}
